...
namespace ePro.DataSources {
    ...
    public partial class _ePro_DB_eProContextDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductListingsDataTable : global::System.Data.TypedTableBase<ProductListingsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductListingsRow AddProductListingsRow(string ProductName, string Source, string ItemCode) {
    ...
    public partial class ProductListingsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[ProductListings] SET [ProductName] = @ProductName, [Source] = @Sour" +
                "ce, [ItemCode] = @ItemCode WHERE (([ProductListingID] = @Original_ProductListing" +
                "ID))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductListingID, ProductName, Source, ItemCode FROM dbo.ProductListings";
        ...
        public virtual int Update(string ProductName, string Source, string ItemCode, int Original_ProductListingID) {
            if ((ProductName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_ProductListingID));
